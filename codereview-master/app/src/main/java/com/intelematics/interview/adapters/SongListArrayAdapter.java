...
public class SongListArrayAdapter extends ArrayAdapter<Song> implements Filterable{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final ImageView albumCover = (ImageView)convertView.findViewById(R.id.album_cover);
		...
		/*if(song.getCover() != null){
			Log.d("CATLOG", "Getting cover now");
    ...
    private void getCover(Song song){
        if(song.getCover() == null){
			...
			//}
			//catch(Exception ex) {
			//	Log.d("CATLOG", "get cover problems" + ex.toString());
			//}
